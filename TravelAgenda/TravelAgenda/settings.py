"""
Django settings for TravelAgenda project.
...
ALLOWED_HOSTS = ['127.0.0.1','localhost','124.70.186.54']
...
WSGI_APPLICATION = 'TravelAgenda.wsgi.application'
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'h1185038823@163.com'
