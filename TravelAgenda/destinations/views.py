...
def destination_hotel(request):
    ...
    # 获取必住的目的地
    destinations = Destination.objects.filter(tags='HOTEL')
    ...
    if stars_query:
        try:
            ...
            destinations = destinations.filter(stars__exact=stars)
        except ValueError:
            pass  # 处理非数字的stars输入
    ...
    return render(request, 'destinations/hotel.html', context)
...
def destination_restaurant(request):
    ...
    # 获取必吃的目的地
    destinations = Destination.objects.filter(tags='EAT')
    ...
    return render(request, 'destinations/restaurant.html', context)
...
def destination_shop(request):
    ...
    # 获取必逛的目的地
    destinations = Destination.objects.filter(tags='VISIT')
    ...
    return render(request, 'destinations/shop.html', context)
...
def destination_attraction(request):
    ...
    # 获取必玩的目的地
    destinations = Destination.objects.filter(tags='PLAY')
